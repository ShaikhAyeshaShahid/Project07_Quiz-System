...
async function AskQuestion() {
    const answers = await inquirer.prompt([
        ...
        },
        {
            ...
            message: (chalk.bold.grey("Which of the following filenames is the extension for typescript ?")),
        },
        {
            type: "list",
            name: "Question4",
            choices: ["Javascript", "C#", "Java", "All of the above"],
            message: (chalk.bold.grey("Which of the computer programming languages below has influenced the creation of typescript ?")),
        },
    ]);
    const marks = 10;
    const fail = 0;
